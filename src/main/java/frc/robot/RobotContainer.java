...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    NamedCommands.registerCommand("Intake", new ParallelDeadlineGroup(new WaitCommand(1), m_gripper.Intake()).andThen( new ParallelDeadlineGroup(new WaitCommand(0.5), m_gripper.stop())));
    NamedCommands.registerCommand("Outtake", new ParallelDeadlineGroup(new WaitCommand(0.7), m_gripper.outtake()).andThen(new ParallelDeadlineGroup(new WaitCommand(0.5), m_gripper.stop())));
