...
public class ModuleIOSim implements ModuleIO {
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.drivePositionMeters = moduleSimulation.getDriveWheelFinalPosition().in(Radians) * kWheelRadiusMeters;
    ...
    inputs.driveVelocityMeterPerSec =
        moduleSimulation.getDriveWheelFinalSpeed().in(RadiansPerSecond) * kWheelRadiusMeters ;
  ...
  public void setDriveVelocity(double velocityRadPerSec) {
    velocityRadPerSec *= 2 / kWheelRadiusMeters*2;
    setDriveVoltage(
