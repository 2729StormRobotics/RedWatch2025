...
public class GyroIOSim implements GyroIO {
  ...
  private final GyroSimulation navx;
  ...
  public GyroIOSim(GyroSimulation gyroSimulation) {
    ...
    resetRoll = 0;
    resetPitch = 0;
    navx.setRotation(new Rotation2d());
  ...
  public double getYawAngle() {
    double angle = navx.getGyroReading().getDegrees() - resetYaw;
