...
public class ArmIOSim implements ArmIO {
    ...
    private static final DCMotor armMotorModel = DCMotor.getNEO(ArmIOConstants.kArmCANID);
    ...
    private SingleJointedArmSim sim = new SingleJointedArmSim(
            armMotorModel,
            ArmIOConstants.ArmSimConstants.kArmReduction,
            SingleJointedArmSim.estimateMOI(ArmIOConstants.ArmSimConstants.kArmLength,
                    ArmIOConstants.ArmSimConstants.kArmMass),
            ArmIOConstants.ArmSimConstants.kArmLength,
            ArmIOConstants.ArmSimConstants.kMinAngleRads,
            ArmIOConstants.ArmSimConstants.kMaxAngleRads,
            true, // change this to true later
            0.1);

    public ArmIOSim() {
        m_encoder = new Encoder(ArmIOConstants.ArmSimConstants.kEncoderAChannel,
                ArmIOConstants.ArmSimConstants.kEncoderBChannel);
        m_encoderSim = new EncoderSim(m_encoder);
        m_encoderSim.setDistancePerPulse(ArmIOConstants.ArmSimConstants.kArmEncoderDistPerPulse);
        m_controller = new ProfiledPIDController(ArmIOConstants.ArmSimConstants.kArmSimPID[0],
                ArmIOConstants.ArmSimConstants.kArmSimPID[1], ArmIOConstants.ArmSimConstants.kArmSimPID[2],
