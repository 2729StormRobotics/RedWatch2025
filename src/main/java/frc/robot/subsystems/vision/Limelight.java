...
public abstract class Limelight extends SubsystemBase {
    ...
    protected Limelight(Drive m_drive, String limelightName, double cameraUpOffset, double cameraPitchDegrees, boolean isInverted) {
    ...
    public void periodic() {
        ...
        // RED:
            ...
            LimelightHelpers.SetRobotOrientation(
                limelightName,
                Math.IEEEremainder(drive.getPose().getRotation().getDegrees() + 180, 360),
                0, 0, 0, 0, 0
            );
        }
